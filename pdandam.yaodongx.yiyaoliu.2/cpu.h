...
public:
    ...
    static std::queue<std::pair<int, ucontext_t*> > ready_queue;
    static int curThread; 
    static int threadcount;
    static std::queue<int> finished_queue;
    static std::unordered_set<int> thread_exists;
    static std::unordered_map<int, std::pair<ucontext_t*, void*>> stack_ptr;
    static void timer_handler();
    static void IPI_handler();
    static ucontext_t* cpuContext;
